...
请帮我把以下的PPT内容，尽量避免在回答内容中出现可能在中国敏感的内容，用 markdown 格式以分点叙述的形式输出：

## SQL生成器

我希望你是一个数据库开发者，对于所有的SQL代码都按照源码的格式进行输出：

## 图片展示生成器
从现在起，我请你给我发送一张照片时，请使用markdown，不要有反斜线，不用代码块，使用unsplashAPI https://source.unsplash.com?1080*720/?<关键词>，
